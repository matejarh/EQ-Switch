...
ImFont* g_fontAwesomeFontFont  = nullptr;
...
void LoadFonts(float baseFontSize)
{
    ...
    g_fontAwesomeFontFont    = loadFont("Font Awesome 7 Free-Solid-900.otf", baseFontSize);
    ...
    if (!g_fontAwesomeFontFont)    std::cerr << "⚠ Failed to load g_fontAwesomeFontFont!\n";
}
